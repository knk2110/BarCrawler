...
templates.editPageStructure = [
	...
	'									<input type="text" class="form-control" id="barSearchFormName" name="name" size="10">',
	'								</div>',
	'								<div class="form-group">',
	...
	'									<input type="text" class="form-control" id="barSearchFormZip" name="postalCode" size="5" maxlength="5" pattern="[0-9]*" placeholder="zip">',
	'								</div>',
	'								<div class="form-group">',
