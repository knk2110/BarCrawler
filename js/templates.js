...
templates.mainPageStructure = [
	...
	'									<input type="text" class="form-control" id="newCrawlFormTitle" size="5" placeholder="Enter a name" autofocus>',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="newCrawlFormDate">Date</label>',
	'									<input type="date" class="form-control" id="newCrawlFormDate">',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="newCrawlFormZip">Near*</label>',
	'									<input type="text" required class="form-control" id="newCrawlFormZip" size="5" maxlength="5" pattern="[0-9]*" placeholder="zip">',
	'								</div>',
	'							</fieldset>',
	'							<br>',
	'							<fieldset class="form-inline">',
	...
	'									<select class="form-control" id="newCrawlFormType">',
	'										<option value=""></option>',
	...
	'									<input type="number" class="form-control" min="0" max="10" width="2" id="newCrawlFormRating" placeholder="0-10">',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="newCrawlFormPrice">Price</label>',
	'									<select class="form-control" id="newCrawlFormPrice">',
	'										<option value=""></option>',
	...
	'								<button type="button" class="btn btn-primary" id="addCrawl" data-dismiss="modal"><span class="glyphicon glyphicon-plus"></span> Add</button>',
	'							</fieldset>',
	'						</form>',
	'					</p>',
	'				</div>',
...
templates.editPageStructure = [
	...
	'			<fieldset class="form-inline">',
	'				<div class="form-group">',
	'					<input type="text" class="form-control" id="crawlFormTitle" size="25" placeholder="Enter a name">',
	'				</div>',
	'				<div class="form-group">',
	'					<input type="date" class="form-control" id="crawlFormDate">',
	'				</div>',
	...
	'									<input type="text" class="form-control" id="barSearchFormName" size="10">',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="barSearchFormType">Type of Bars</label>',
	'									<select class="form-control" id="barSearchFormType">',
	'										<option value=""></option>',
	'										<option value="4bf58dd8d48988d116941735">Bar</option>',
	'										<option value="4bf58dd8d48988d117941735">Beer Garden</option>',
	'										<option value="50327c8591d4c4b30a586d5d">Brewery</option>',
	...
	'									<input type="text" class="form-control" id="barSearchFormZip" size="5" maxlength="5" pattern="[0-9]*" placeholder="zip">',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="barSearchFormRating">Rating</label>',
	'									<input type="number" class="form-control" min="0" max="10" width="2" id="barSearchFormRating" placeholder="0-10">',
	'								</div>',
	'								<div class="form-group">',
	'									<label for="barSearchFormPrice">Price</label>',
	'									<select class="form-control" id="barSearchFormPrice">',
	'										<option value=""></option>',
	'										<option value="1">$</option>',
	'										<option value="2">$$</option>',
	'										<option value="3">$$$</option>',
	...
	'							<br>',
	'							<fieldset class="form-inline">',
	'								<button type="button" class="btn btn-primary" id="crawlFormSearch">Search</button>',
	'							</fieldset>',
	'						</form>',
	'						<hr>',
	'						<form class="form-horizontal" role="form">',
	'							<div class="form-group">',
	'								<label for="barSearchFormSort" class="col-md-2 control-label">Sort</label>',
	'								<div class="col-md-5">',
